...
void initPWM(int address, int *pwmHatFD)
{
    cout << "Init PWM on address " << address << endl;
    *pwmHatFD = wiringPiI2CSetup(address);
    cout << "pwmHatFD = " << *pwmHatFD << endl;


    // zero all PWM ports
    setAllPWM(0,0,*pwmHatFD);
    ...
    setPWMFreq(60,*pwmHatFD);
}

void setPWMFreq(int freq,int pwmHatFD)
{
    //cout << "setPWMFreq pwmHatFD = " << pwmHatFD << endl;
...
void setPWM(int channel, int on, int off, int pwmHatFD)
{
    //cout << "setPWM pwmHatFD = " << pwmHatFD << endl;
...
void setAllPWM(int on, int off,int pwmHatFD)
{
    //cout << "setAllPWM pwmHatFD = "<< pwmHatFD << endl;
